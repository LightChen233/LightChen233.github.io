...
- 🔥 <span class="conference-tag">AAAI 2025</span> [Divide-Solve-Combine: An Interpretable and Accurate Prompting Framework for Zero-shot Multi-Intent Detection](https://xxx), Libo Qin\*, **Qiguang Chen**\*, Jingxuan Zhou, Jin Wang, Hao Fei, Wanxiang Che, Min Li. <span class="reasoning-tag">Reasoning</span>
